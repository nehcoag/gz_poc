...
var basedata01 = [77.3, 69.2, 99.3, 30.0, 99.6, 90.6, 50.0, 91.5, 69.8, 67.5, 70.4, 84.9];
var basedata02 = [84.2, 81.0, 67.5, 72.1, 43.7, 88.5, 91.9, 41.8, 79.7, 87.6, 92.9, 0];
var basedataLineArr=[basedata,basedata01,basedata02];
var baseXdata = ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'];
var curdata = basedata.slice(0, 5);
var curdata01 = basedata01.slice(0, 5);
var curdata02 = basedata02.slice(0, 5);
...
var basedataBar01 = [100, 200, 300, 400, 500, 600, 700, 800, 900];
var basedataBar02 = [100, 200, 300, 400, 500, 600, 700, 800, 900];
var basedataArr=[
    basedataBar,
    basedataBar01,
    basedataBar02
